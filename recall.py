...
parser.add_argument('--logfile', default='test_recall1.log')
...
if __name__ == '__main__':
    ...
    recall_final['sim_score'] = recall_final['sim_score'] / weight_sum
    ...
    # 保存到本地
    if mode == 'valid':
        df_useful_recall.to_pickle('../user_data/data/offline/recall1.pkl')
    elif mode == 'test':
